    ...
    <div class="mx-auto max-w-screen-xl pt-10">
      ...
      <div>
        <img
          ...
          alt="Vital Cities interactive website mockup with data visualizations"
          loading="lazy"
        />
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div class="overview-card px-6 py-8">
            ...
            <div class="flex flex-wrap gap-2">
              <span class="overview-badge">Gatsby</span>
              <span class="overview-badge">TypeScript</span>
              <span class="overview-badge">CSS</span>
            </div>
          </div>
          <div class="overview-card px-6 py-8">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <span class="overview-badge">Gatsby</span>
              <span class="overview-badge">Adobe After Effects</span>
              <span class="overview-badge">Adobe XD</span>
              <span class="overview-badge">LottieFiles</span>
            </div>
          </div>
        </div>
