<template>
  <article class="detail-page pb-10 fade-out">
    <div class="mx-auto max-w-screen-xl px-4 pt-10 sm:px-6">
      ...
      <div>
        <img
          class="w-90% mx-auto my-10 rounded-lg md:block md:w-300"
          src="/BikeRental.jpg"
      ...
      <div class="md:mx-10 mx-5 pt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div class="overview-card px-6 py-8">
            <h3 class="overview-label">{{ $t('bikeRental.languages') }}</h3>
            <div class="flex flex-wrap gap-2">
              ...
              <span class="tag-pill">NestJs</span>
              <span class="tag-pill">GraphQL</span>
              <span class="tag-pill">Apollo</span>
              <span class="tag-pill">TailwindCSS</span>
            </div>
          </div>
          <div class="overview-card px-6 py-8">
            <h3 class="overview-label">{{ $t('bikeRental.tools') }}</h3>
            <div class="flex flex-wrap gap-2">
              <span class="tag-pill">Visual Studio Code</span>
              <span class="tag-pill">Mapbox</span>
