    ...
    <div class="mx-auto max-w-screen-xl pt-10">
      <div class="text-center">
        ...
        <div
          ...
          <div class="mr-5">
            <p>Azure Search & Amazon OpenSearch</p>
          </div>
          <div class="mr-5">
      ...
      <div>
        ...
        <img class="scale h-120 my-5 mx-auto block md:hidden" src="/AzureIphone.png" alt="Iphone mockup" />
      </div>
      <div>
        <div class="md:m-10 m-5 flex justify-between pt-10">
